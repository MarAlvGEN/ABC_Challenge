...
- **Efecto flip 3D**: Al hacer clic en una card revela una imagen representativa y la palabra en español.
- **Contador inteligente**: Detecta la cantidad de tarjetas visibles en el momento.
...
- Cada integrante trabajó en su propia rama, organizadas por features.
...
- El progreso se gestionó con un tablero de Trello, reflejando en todo momento el estado real del desarrollo.

### 📋 Tablero de Trello

<img width="1308" height="636" alt="image" src="https://github.com/user-attachments/assets/71c4a936-a0f4-4e26-acaa-87c6796ede15" />
